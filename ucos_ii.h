...
OS_TLS_ID     OS_TLS_GetID            (INT8U               *perr) REENTRANT;

OS_TLS        OS_TLS_GetValue         (OS_TCB              *ptcb,
                                       OS_TLS_ID            id,
                                       INT8U               *perr) REENTRANT;

void          OS_TLS_Init             (INT8U               *perr) REENTRANT;
...
void          OS_TLS_TaskCreate       (OS_TCB              *ptcb) REENTRANT;

void          OS_TLS_TaskDel          (OS_TCB              *ptcb) REENTRANT;

void          OS_TLS_TaskSw           (void) REENTRANT;
...
INT8U         OSTaskRegGetID          (INT8U           *perr) REENTRANT;
