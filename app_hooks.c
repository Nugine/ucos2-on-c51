...
void App_TaskCreateHook(OS_TCB *ptcb) REENTRANT  { ptcb = ptcb; }
...
void App_TaskDelHook(OS_TCB *ptcb) REENTRANT { ptcb = ptcb; }
...
*the idle task.  This hook has been added to allow you to do such things as STOP
*the CPU to conserve power.
*
* Argument(s) : none.
*
...
*every second by uC/OS-II's statistics task.  This allows your application to
*add functionality to the statistics task.
*
* Argument(s) : none.
*********************************************************************************************************
*/
...
#if OS_VERSION >= 289
void App_TaskReturnHook(OS_TCB *ptcb) REENTRANT { ptcb = ptcb; }
#endif
...
*task) and, 'OSTCBCur' points to the task being switched out (i.e. the preempted
*task).
*********************************************************************************************************
*/
...
#if OS_VERSION >= 204
void App_TCBInitHook(OS_TCB *ptcb) REENTRANT { ptcb = ptcb; }
#endif
